...
List<Product> priceList = new List<Product>
{
    ...
    new Product(){Name="Power",ProductType=TypeOfProduct.Frame,Price=800,Id=8},
...
Console.WriteLine("Введите дату продажи в формате YYYY.MM.dd: ");
...
class Sale
{
    ...
    public decimal Discount { get; set; }
    public decimal Total() => Count * Product.Price - Count * Product.Price * Product.Discount;
}
class SalePerson
{
